function [sys,x0,str,ts,simStateCompliance] = Fobsv5(t,x,u,flag)
...
z1=[u(3)-u(1);u(5)-u(1);u(7)-u(1);u(9)-u(1);x(1)-u(1)];
z2=[u(4)-u(2);u(6)-u(2);u(8)-u(2);u(10)-u(2);x(2)-u(2)];
L = [2 -1 -1 0 0;-1 2 0 -1 0;-1 0 3 -1 -1;0 -1 -1 2 0;0 0 -1 0 1];
B = diag([1,0,0,0,1]);
mu = u(11); Tc = u(12); neta = u(13); w1 = u(14); w2 = u(15); gama_n = u(16);
f1 = 1.2*x(1)*sin(x(1)*x(1));
f2 = 1.2*x(1)*x(2)*x(2);
p1 = -1/(0.2841^(1-mu/2));
p2 = -1/(0.2841^(1-mu/2));
